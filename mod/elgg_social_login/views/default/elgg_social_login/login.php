		...
		if( get_plugin_setting( 'ha_settings_' . $provider_id . '_enabled', 'elgg_social_login' ) ){
			...
			<div class='butSignUP'>
				<a 	href="javascript:void(0);" 
					title="Connect with <?php echo $provider_name ?>" class="ha_connect_with_provider" 
					provider="<?php echo $provider_id ?>" 
					onClick="_gaq.push(['_trackEvent','SignUP-Teachers','SendForm','T1 - <?php echo $provider_name ?>']);">
