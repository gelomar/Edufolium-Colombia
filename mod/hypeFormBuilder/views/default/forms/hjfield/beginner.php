...
$beginner_options_label = elgg_echo('hj:formbuilder:label:field_options:beginner');
$beginner_options_input = elgg_view('input/text', array(
    'name' => 'beginner_field_options',
    'value' => $field->beginner_options,
        ));
$beginner_options_hint = elgg_echo('hj:formbuilder:hint:field_options:beginner');


//$options_label = elgg_echo('hj:formbuilder:label:field_options');
$options_input = elgg_view('input/hidden', array(
    'name' => 'field_options',
    'value' => $field->options,
        ));
...
$options_values_input = elgg_view('input/hidden', array(
...
$form_body = <<<HTML
    ...
    <div>
        <label for="field_options">$beginner_options_label</label>
            $beginner_options_input
            <div>$beginner_options_hint</div>
    </div>
    <div>
