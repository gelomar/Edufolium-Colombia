...
$action_input = elgg_view('input/text', array(
    'name' => 'form_action',
    'value' => $form->action,
    'class' => 'mandatory',
        ));
...
$method_input = elgg_view('input/dropdown', array(
    'name' => 'form_method',
    'value' => $form->method,
...
$enctype_input = elgg_view('input/dropdown', array(
    'name' => 'form_enctype',
    'value' => $form->enctype,
...
$entity_type_input = elgg_view('input/text', array(
    'name' => 'subject_entity_type',
    'value' => $form->subject_entity_type,
        ));
$entity_subtype_input = elgg_view('input/text', array(
...
$mode_input = elgg_view('input/hidden', array('name' => 'mode', 'value' => 'advanced'));
