	...
	$connect_menu = '
				<div id="ib_butsNavigate" style="margin-top: -10px; margin-bottom: -10px;">				
					<div id="ib_butActivity" style="display:none">
						<a href="/colombia/activity" >
							<span>
								<img src="/colombia/_graphics/activity.png">
							</span>
						</a>
					</div>
					<div id="ib_butMap" style="display:none">
						<a href="/colombia/membersmap">
							<span>
								<img src="/colombia/_graphics/map.png">
							</span>
						</a>
					</div>
					<div id="ib_butMember" style="display:none">
						<a href="/colombia/members">
							<span>
								<img src="/colombia/_graphics/member.png">
							</span>
						</a>
					</div>						
				</div>
